 ...
 */
public class PetBackEndApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new PetBackEndApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new PetBackEndApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "webminds.group.pet_backend.api.configuration.security.SecurityConfiguration");
