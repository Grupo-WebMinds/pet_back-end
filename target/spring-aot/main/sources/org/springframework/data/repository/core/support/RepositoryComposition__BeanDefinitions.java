...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.ServicePetRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ArquivoRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.PetRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.AssignmentServiceEmployeeRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.SchedulingRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.AuthUserRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.PetShopRepository.fragments#0'.
     */
