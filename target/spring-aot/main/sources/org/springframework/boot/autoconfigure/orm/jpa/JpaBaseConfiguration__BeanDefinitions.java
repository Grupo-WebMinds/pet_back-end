...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static BeanDefinition getTransactionManagerBeanDefinition() {
    ...
    beanDefinition.setTargetType(PlatformTransactionManager.class);
  ...
  public static BeanDefinition getJpaVendorAdapterBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition();
    beanDefinition.setTargetType(JpaVendorAdapter.class);
  ...
  public static BeanDefinition getEntityManagerFactoryBuilderBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition();
    beanDefinition.setTargetType(EntityManagerFactoryBuilder.class);
  ...
  public static BeanDefinition getEntityManagerFactoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition();
    beanDefinition.setTargetType(LocalContainerEntityManagerFactoryBean.class);
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("webminds.group.pet_backend.domain.arquivo.Arquivo", "webminds.group.pet_backend.domain.pet.Pet", "webminds.group.pet_backend.domain.petShop.PetShop", "webminds.group.pet_backend.domain.scheduling.Scheduling", "webminds.group.pet_backend.domain.service.AssignmentServiceEmployee", "webminds.group.pet_backend.domain.service.ServicePet", "webminds.group.pet_backend.domain.user.AuthUser", "webminds.group.pet_backend.domain.user.Employee");
  ...
  public static class JpaWebConfiguration {
    ...
    public static BeanDefinition getOpenEntityManagerInViewInterceptorBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition();
      beanDefinition.setTargetType(OpenEntityManagerInViewInterceptor.class);
    ...
    public static BeanDefinition getOpenEntityManagerInViewInterceptorConfigurerBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition();
      beanDefinition.setTargetType(WebMvcConfigurer.class);
