...
public class WebMvcObservationAutoConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<FilterRegistrationBean> getWebMvcObservationFilterInstanceSupplier(
    ...
    return BeanInstanceSupplier.<FilterRegistrationBean>forFactoryMethod(WebMvcObservationAutoConfiguration.class, "webMvcObservationFilter", ObservationRegistry.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(WebMvcObservationAutoConfiguration.class).webMvcObservationFilter(args.get(0), args.get(1), args.get(2), args.get(3)));
  }
  ...
  public static class MeterFilterConfiguration {
    ...
    private static BeanInstanceSupplier<MeterFilter> getMetricsHttpServerUriTagFilterInstanceSupplier(
      ...
      return BeanInstanceSupplier.<MeterFilter>forFactoryMethod(WebMvcObservationAutoConfiguration.MeterFilterConfiguration.class, "metricsHttpServerUriTagFilter", MetricsProperties.class, ObservationProperties.class)
