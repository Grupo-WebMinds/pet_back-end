...
public class RestTemplateObservationConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<ObservationRestTemplateCustomizer> getObservationRestTemplateCustomizerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ObservationRestTemplateCustomizer>forFactoryMethod(RestTemplateObservationConfiguration.class, "observationRestTemplateCustomizer", ObservationRegistry.class, ObjectProvider.class, ObservationProperties.class, MetricsProperties.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(RestTemplateObservationConfiguration.class).observationRestTemplateCustomizer(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4)));
  }
  ...
  public static BeanDefinition getObservationRestTemplateCustomizerBeanDefinition() {
    ...
    beanDefinition.setTargetType(ObservationRestTemplateCustomizer.class);
